...
function ability_mist_coil:OnSpellStart()
    ...
    combatDamage.dealDamage(self:GetCaster(), target, tonumber(self:GetSpecialValueFor("damage")) or 90,
    ...
    if selfDamage > 0 then
        combatDamage.dealDamage(self:GetCaster(), self:GetCaster(), selfDamage,
