if ability_magic_missile == nil then
    ability_magic_missile = class({})
end

--------------------------------------------------------------------------------

function ability_magic_missile:OnSpellStart()
...
function ability_magic_missile:OnProjectileHit(Target, Location)
