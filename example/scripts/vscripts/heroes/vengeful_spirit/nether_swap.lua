if ability_nether_swap == nil then
    ability_nether_swap = class({})
end

--------------------------------------------------------------------------------

function ability_nether_swap:CastFilterResultTarget( target )
...
function ability_nether_swap:OnSpellStart()
