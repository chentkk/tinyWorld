LinkLuaModifier( "modifier_ability_bloodseeker_thirst", "heroes/bloodseeker/thirst" ,LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_bloodseeker_thirst_vision", "heroes/bloodseeker/thirst" ,LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ability_bloodseeker_thirst_speed", "heroes/bloodseeker/thirst" ,LUA_MODIFIER_MOTION_NONE )
