...
LinkLuaModifier( "modifier_ability_shadow_wave", "heroes/dazzle/shadow_wave", LUA_MODIFIER_MOTION_NONE )

--------------------------------------------------------------------------------
-- Ability Start
function ability_shadow_wave:OnSpellStart()
...
function ability_shadow_wave:Jump( jumps, source, target )
	-- Heal
...
--------------------------------------------------------------------------------
function ability_shadow_wave:PlayEffects1( source, target )
	-- Get Resources
...
function ability_shadow_wave:PlayEffects2( target )
	-- Get Resources
